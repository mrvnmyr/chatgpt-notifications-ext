...
def main():
  ...
  parser.add_argument("-s", "--src", default="extension", help="Source directory containing manifest.json (default: extension)")
  parser.add_argument("-o", "--out", default="dist", help="Output directory for the zip (default: dist)")
  parser.add_argument("-n", "--name", default=None, help="Override the zip file name (e.g., my-ext.zip)")
